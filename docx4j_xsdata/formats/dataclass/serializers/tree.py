...
from docx4j_xsdata.formats.dataclass.serializers.mixins import EventGenerator
from docx4j_xsdata.formats.dataclass.serializers.writers.lxml import LxmlTreeBuilder
