...
from docx4j_xsdata.formats.dataclass.parsers import DictDecoder, XmlParser
from docx4j_xsdata.formats.dataclass.serializers import XmlSerializer
from docx4j_xsdata.formats.dataclass.transports import DefaultTransport, Transport
