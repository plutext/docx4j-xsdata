...
from docx4j_xsdata.codegen import opener
...
from docx4j_xsdata.codegen.parsers.definitions import DefinitionsParser
from docx4j_xsdata.codegen.parsers.schema import SchemaParser
from docx4j_xsdata.codegen.stopwatch import stopwatch, stopwatches
...
from docx4j_xsdata.models.wsdl import Definitions
...
class ResourceTransformer:
    ...
    def get_cache_file(cls, uris: list[str]) -> Path:
        ...
        return Path(tempdir).joinpath(f"docx4j-xsdata.{__version__}.{key}.cache")
