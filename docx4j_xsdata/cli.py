...
from docx4j_xsdata.models.config import GeneratorConfig, GeneratorOutput
from docx4j_xsdata.utils.click import URL, LogFormatter, LogHandler, model_options
from docx4j_xsdata.utils.downloader import Downloader
from docx4j_xsdata.utils.hooks import load_entry_points

# Load cli plugins
load_entry_points("docx4j_xsdata.plugins.cli")
...
def cli(ctx: click.Context, **kwargs: Any) -> None:
    ...
    logger.info(
        "========= docx4j-xsdata v%s / Python %s / Platform %s =========\n",
        __version__,
