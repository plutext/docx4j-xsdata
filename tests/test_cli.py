...
from docx4j_xsdata.cli import cli, resolve_source
...
from docx4j_xsdata.models.config import GeneratorConfig, StructureStyle
...
class CliTests(TestCase):
    ...
    @mock.patch("docx4j_xsdata.cli.logger.info")
