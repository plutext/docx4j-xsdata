...
The [docx4j_xsdata.codegen.transformer][docx4j_xsdata.codegen.transformer] will detect and switch
...
```console
$ pip install docx4j-xsdata[cli]
```

## Command Line Tool

```console exec="1" source="console"
$ docx4j-xsdata generate --help
```
...
```console
$ docx4j-xsdata generate project/schemas
$ docx4j-xsdata generate project/schemas --recursive
```

## Use a filename or URI as source

```console
$ docx4j-xsdata generate project/schemas/feed.xsd
$ docx4j-xsdata generate http://www.gstatic.com/localfeed/local_feed.xsd
```
